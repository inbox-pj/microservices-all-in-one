package com.usl.microservices.paymentvalidation.utils;
...
public class APIContextFilter implements Filter {
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2)
		...
		LOGGER.debug("Validation Service Incoming Correlation id: {}", APIContextHolder.getContext().getCorrelationId());
