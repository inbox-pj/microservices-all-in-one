package com.usl.microservices.cartprocessing;
...
import com.usl.microservices.cartprocessing.utils.APIContextInterceptor;
...
@EnableSwagger2
@RefreshScope
public class CartProcessingApplication {

	@Autowired
	private ServiceConfig serviceConfig;
	
	public static void main(String[] args) {
		SpringApplication.run(CartProcessingApplication.class, args);
	}
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.usl.microservices.cartprocessing"))
