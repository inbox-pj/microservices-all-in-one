package com.usl.microservices.paymentprocessing;
...
import com.usl.microservices.paymentprocessing.utils.APIContextInterceptor;
...
public class PaymentProcessingApplication {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.usl.microservices.paymentprocessing"))
